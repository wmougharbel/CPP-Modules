...
RobotomyRequestForm::RobotomyRequestForm() : Form("Robotomy", 75, 45), _target("undefined")
{
	std::cout << "Robotomy default constructor created" << std::endl;
}

RobotomyRequestForm::RobotomyRequestForm(std::string target) : Form("Robotomy", 75, 45), _target(target)
{
